...
class STMetaLearner_add(nn.Module):
    def __init__(self, model_args, task_args, emb_param_list):
        super(STMetaLearner_add, self).__init__()
        self.model_args = model_args
        self.emb_param = emb_param_list
        self.task_args = task_args
...
class MetaSTNN(nn.Module):
    ...
    def build(self):
        self.mk_learner = STMetaLearner_add(self.model_args, self.task_args, self.emb_param )
